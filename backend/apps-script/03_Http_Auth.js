...
function sistemaBootstrap_(){
  return Object.assign({
    ...
    endpoints:[
      "auth.login","auth.first_access.complete","auth.recovery.request","auth.logout","sistema.warmup","cmms.schema_upgrade","cmms.paradas_operacionais_schema_upgrade","cmms.horimetro_evidencias_schema_upgrade","cmms.catalogo_checklist_schema_upgrade","cmms.workflow_tecnico_schema_upgrade","cmms.configuracao_schema_upgrade","cmms.importacao_admin_schema_upgrade","cmms.operador_visual_schema_upgrade","cmms.tela_operador_schema_upgrade","cmms.operador_ui_schema_upgrade","cmms.operacional_ui_schema_upgrade","cmms.contrato_frontend_schema_upgrade","cmms.frontend_contract_schema_upgrade","cmms.execucao_checklist_schema_upgrade","cmms.auditoria_operador_schema_upgrade","admin.resumo","admin.resumo_cache","admin.listar","admin.salvar","admin.usuarios.listar","admin.usuarios.salvar","admin.usuarios.desbloquear","admin.usuarios.redefinir_senha","admin.usuarios.revogar_sessoes","admin.permissoes.obter","admin.permissoes.salvar","admin.configuracao.estado","admin.configuracao.rascunho.salvar","admin.configuracao.validar","admin.configuracao.publicar","admin.configuracao.versoes","admin.configuracao.rollback","admin.importacao.modelos","admin.importacao.validar","admin.importacao.confirmar","admin.importacao.lotes","admin.importacao.detalhe","admin.importacao.rollback","admin.areas_tecnicas.listar","admin.areas_tecnicas.salvar","admin.cargos_tecnicos.listar","admin.cargos_tecnicos.salvar","admin.demandas_tecnicas.enviar","admin.demandas_tecnicas.listar","admin.analises_tecnicas.listar","admin.analises_tecnicas.converter","admin.intervencoes.listar","admin.intervencoes.salvar","admin.intervencoes.enviar_validacao","admin.documentos.listar","admin.documentos.detalhe","admin.documentos.upload","admin.documentos.atualizar","admin.auditoria.listar","admin.monitoramento.estado","admin.backups.listar","admin.backups.criar","admin.gerar_qr","admin.criar_demo","admin.recalcular_ativo",
