...
const PERM = {
  ADMIN: [
    ...
    "sistema.warmup", "admin.resumo", "perf.cache_clear", "perf.cache_status", "admin.resumo_cache", "admin.listar", "admin.obter", "admin.salvar", "admin.usuarios.listar", "admin.usuarios.salvar", "admin.usuarios.desbloquear", "admin.usuarios.redefinir_senha", "admin.usuarios.revogar_sessoes", "admin.permissoes.obter", "admin.permissoes.salvar", "admin.empresa.obter", "admin.empresa.salvar", "admin.acesso.estado", "admin.gerar_qr", "admin.criar_demo", "admin.recalcular_ativo",
