...
const PERM = {
  ADMIN: [
    ...
    "gestor.contexto_tecnico", "gestor.demandas.listar", "gestor.demandas.detalhe", "gestor.demandas.assumir", "gestor.demandas.encaminhar", "gestor.demandas.assinar", "gestor.demandas.validar", "gestor.demandas.decidir", "gestor.paradas.criar_tratamento", "gestor.analises.salvar", "gestor.analises.enviar_admin", "gestor.notificacoes.listar", "gestor.notificacoes.marcar_lida",
